...
# Load data
dat <- read.csv("YX1_rev/YX1_rev.csv") # Original d18O data with year markers
age_model_results <- read.csv("YX1_rev/Age_model_results.csv") # Results in terms of age (DOY)
Growth_rate_results <- read.csv("YX1_rev/Growth_rate_results.csv") # Results in terms of growth rate (um/day)
...
# Export results
write.csv(merged_dat, "YX1_rev/Realigned_age_model_results_MC.csv", row.names = FALSE)
write.csv(simulated_age_models, "YX1_rev/Realigned_age_model_simulations.csv", row.names = FALSE)
...
ggtitle("Age model realignment for specimen YX1_rev") +
theme_minimal()
