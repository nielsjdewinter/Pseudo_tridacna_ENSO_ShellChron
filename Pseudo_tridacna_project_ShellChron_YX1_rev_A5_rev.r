...
# ------------------------------------------------------------------------------
# Dataset YX1_rev
dat <- read.csv("YX1_rev/YX1_rev.csv") |> # Load data
...
wrap_function(
    ...
    export_path = "C:/Users/nwi213/Dropbox/Research/Manuscripts/[Review] Paleoceanography and Paleoclimatology - ENSO pseudo-tridacna methods paper Han tao/SI_data_processing/YX1_rev"
)
# DONE

# ------------------------------------------------------------------------------
# Dataset A5_rev
dat <- read.csv("A5_rev/A5_rev.csv") |> # Load data
mutate( # Multiply D values by 1000
    D = D * 1000,
    D_err = D_err * 1000
)
...
plot_export = TRUE # Should a plot of the results be saved as PDF?
export_raw = TRUE # Should the results of all individual model runs be exported as CSV files?
export_path = "C:/Users/nwi213/Dropbox/Research/Manuscripts/[Review] Paleoceanography and Paleoclimatology - ENSO pseudo-tridacna methods paper Han tao/SI_data_processing/A5_rev"
