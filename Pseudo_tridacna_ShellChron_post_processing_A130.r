...
# Load data
dat <- read.csv("A130/A130.csv") # Original d18O data with year markers
age_model_results <- read.csv("A130/Age_model_results.csv") # Results in terms of age (DOY)
Growth_rate_results <- read.csv("A130/Growth_rate_results.csv") # Results in terms of growth rate (um/day)
...
# Export results
write.csv(merged_dat, "A130/Realigned_age_model_results_MC.csv", row.names = FALSE)
write.csv(simulated_age_models, "A130/Realigned_age_model_simulations.csv", row.names = FALSE)
...
ggtitle("Age model realignment for specimen A130") +
theme_minimal()
